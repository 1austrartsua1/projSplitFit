...
processors = [backLB,f2fixed,f2bt,f2affine,f1fixed,f1bt,back_exact]

testNumber = 0
Tests = []
for proc in processors:
    for eq in [False,True]:
        Tests.append((proc,testNumber,eq))
        testNumber += 1

@pytest.mark.parametrize("processor,testNumber,equalize",Tests)
